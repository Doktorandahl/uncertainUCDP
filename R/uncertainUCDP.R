...
#'
#' @description
#' Function for extracting parameters for the reported-value inflated Gumbel mixture distribution for UCDP events. Primarily intended for internal use by the uncertainUCDP-functions, but can be used to extract parameters for the distribution manually.
#'
...
#'
#' @description
#' Density, distribution function, quantile function and random generation for the parametric reported-value inflated Gumbel mixture distribution for UCDP events. The functions estimate the parameters of the distribution based on the number of fatalities and the type of violence of the UCDP event.
#'
#' @details
...
#' Function for calculating the mean, median, and quantiles of the parametric uncertainty distributions for UCDP events
#'
#' @description
#' These fuctions calculate the mean, median, and quantiles of the parametric uncertainty distributions for UCDP events. The parametric uncertainty distributions are based on the reported-value inflation Gumbel mixture distribution. The \code{median} and \code{quantile} functions are shortcuts for the \code{quncertainUCDP} function.
#'
#'
#' @param fatalities A vector of non-negative integers representing the number of fatalities of the UCDP events. Non-integer values are allowed but should be considered experimental.
#' @param tov A character string representing the type of violence of the UCDP. Must be one of "sb", "ns", "os", or "any". The options are:
